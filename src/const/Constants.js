...
export const RECONCILE_PATH = "/BankRec/BankRec.aspx";

export const RECONCILE_BUTTON_CLICK_INTERVAL = 200;

export const GOOGLE_ID = "G-PCV00W743P";

export const GTAG_EVENT_BULK_RECONCILE = "bulk_reconcile";
